...
plink --file SumSats/SE132.1707.plink --freq --within RDA.SE.data2/SE132.pop.cluster --out RDA.SE.data2/SE132.data2.pop
...
bio13.scaled + bio18.scaled + bio2.scaled, data = Climate.Data)
              ...
              Inertia Proportion Rank
Total         82.7915     1.0000     
Constrained   62.7877     0.7584    7
Unconstrained 20.0038     0.2416    7
Inertia is variance 

Eigenvalues for constrained axes:
  RDA1   RDA2   RDA3   RDA4   RDA5   RDA6   RDA7 
27.338 13.161  8.631  5.348  4.305  2.337  1.667 

Eigenvalues for unconstrained axes:
  PC1   PC2   PC3   PC4   PC5   PC6   PC7 
6.153 3.722 3.171 2.197 2.049 1.645 1.067 
...
![alt_txt][RDA.SEfull]
[RDA.SEfull]:https://cloud.githubusercontent.com/assets/12142475/20986428/f39dca0e-bcc8-11e6-800e-898be9170acb.png
...
Climate.Data)
              ...
              Inertia Proportion Rank
Total         82.7915     1.0000     
Conditional   31.1319     0.3760    2
Constrained   31.6558     0.3824    5
Unconstrained 20.0038     0.2416    7
Inertia is variance 

Eigenvalues for constrained axes:
  RDA1   RDA2   RDA3   RDA4   RDA5 
14.340  8.703  4.348  2.584  1.680 
...
[Data2.pRDA.geog]:https://cloud.githubusercontent.com/assets/12142475/20986809/64bdb040-bcca-11e6-9eb2-2532165236dc.png)
...
Climate.Data)
               ...
               Inertia Proportion Rank
Total         82.79150    1.00000     
Conditional   55.65700    0.67226    5
Constrained    7.13071    0.08613    2
Unconstrained 20.00379    0.24162    7
Inertia is variance 
...
Importance of components:
                        RDA1   RDA2   RDA3    RDA4    RDA5
Eigenvalue            14.340 8.7031 4.3481 2.58444 1.67979
Proportion Explained   0.453 0.2749 0.1373 0.08164 0.05306
Cumulative Proportion  0.453 0.7279 0.8653 0.94694 1.00000

                 RDA1    RDA2    RDA3       RDA4     RDA5 PC1
bio5.scaled   0.11031 -0.1672  0.2342 -0.0570051 -0.11660   0
bio15.scaled  0.51812  0.2277  0.3159 -0.0500398  0.05055   0
bio13.scaled  0.46760 -0.2401 -0.3057 -0.2295653  0.51329   0
bio18.scaled  0.47684 -0.0731  0.2031 -0.0006795  0.26125   0
bio2.scaled  -0.04834 -0.1382  0.2571 -0.0660445  0.01668   0
```
...
##linux
vcftools --vcf SE132.FINAL.vcf --snps outliernames.vcffriendly --recode --recode-INFO-all --out SE132.outliers
After filtering, kept 235 out of a possible 2081 Sites
```

Calculate MAF for all loci in Plink:

```
vcftools --vcf SE132.outliers.recode.vcf --plink --out SE132.235outliers.plink

plink --file SE132.235outliers.plink --recode --recodeA --out SE132.235outliers.plink
```
...
```
plink --file SE132.235outliers.plink --within SE132.235.PlinkCluster --freq --out SE132.235.plink
```
...
SE.MAF <- read.table("SE132.235.plink.frq.strat", header = T)
head(SE.MAF)
...
write.csv(SE.MAF3, file="SE132.235.MAF.csv")
```
...
spplot(climate$bio2, main="BIO2:Mean Diurnal Range", 
       sp.layout = c("sp.points", spdf, col="black", pch=16))
       
##Extract point location information:

presvals <- extract(climate2, SE2000random.coords)   ##extract bioclim data for point locations
head(presvals)
...
all_PCs
#Standard deviations:
#[1] 0.0086999993 0.0006554753 0.0002783289 0.0002116934
#
#Rotation:
#                PC1           PC2           PC3           PC4
#MEM1   0.0037328440 -0.9999901211  0.0008205123  2.269436e-03
#bio15  0.9999922652  0.0037316132 -0.0012389773 -9.791412e-05
#MEM2  -0.0012339205 -0.0007805782 -0.9998076198  1.955995e-02
#MEM3   0.0001135994  0.0022854899  0.0195579950  9.998061e-01
...
#Importance of components:
#                          PC1       PC2       PC3       PC4
#Standard deviation     0.0087 0.0006555 0.0002783 0.0002117
#Proportion of Variance 0.9928 0.0056400 0.0010200 0.0005900
#Cumulative Proportion  0.9928 0.9984000 0.9994100 1.0000000
