...
Determine the overlap between loci associated with bioxx for BayEnv: 




And compare with other methods via Venn diagram and overlap on the Fst plot. 
...
RDA1.hist <- hist(RDA1.fst, breaks=115)
RDA2.hist <- hist(RDA2.fst, breaks=115)
