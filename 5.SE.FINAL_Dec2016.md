...
/Users/alexjvr/2016RADAnalysis/5_SE.MS1/DEC2016_SEonly/LFMM
...
```
#
env <- read.csv("SE.145.MAF.csv", header=T) ###read in the environmental data
env <- env[,10:14]
...
```
library(LEA)
genotype = vcf2lfmm("SE145.FINAL.vcf")

	- number of detected individuals:	145
