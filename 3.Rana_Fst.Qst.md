...
After looking at pyRAD results, I will rerun pyRAD with max het set to 0.7. And downsample reads from each individual to better estimate the nucleotide diversity. 
