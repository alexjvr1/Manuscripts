...
Since all the outlier analyses and EAA are affected by low allele frequencies, I will filter these subsets for MAF of 5% and use these as the final dataset: 
```
vcftools --vcf CHall.940.9608.newnames.vcf --maf 0.05 --recode --recode-INFO-all --out CHall.940.9078
vcftools --vcf CHN.229.9608.recode.vcf --maf 0.05 --recode --recode-INFO-all --out CHN.229.5960.recode.vcf
vcftools --vcf CHS.283.9608.recode.vcf --maf 0.05 --recode --recode-INFO-all --out CHS.283.7099.recode.vcf
vcftools --vcf CHS.VS.135.9608.recode.vcf --maf 0.05 --recode --recode-INFO-all --out CHS.VS.135.6593.recode.vcf
vcftools --vcf CHS.TI.148.9608.recode.vcf --maf 0.05 --recode --recode-INFO-all --out CHS.TI.148.6298.recode.vcf
vcftools --vcf CZ.404.9608.recode.vcf --maf 0.05 --recode --recode-INFO-all --out CZ.404.8115.recode.vcf
```

And since stba does not have environmental data, I will remove this population from all further analyses: 
```
...
CHall.932.9078.recode.vcf

CHN.229.5960.recode.vcf	

CHS.275.7099.recode.vcf

CHS.VS.135.6593.recode.vcf

CHS.TI.140.6298.recode.vcf

CZ.404.8115.recode.vcf
