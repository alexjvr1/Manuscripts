...
distance.matrix.CHall <- rdist.earth(CHall_lon.lat)  ##great circle dist based on the coordinates
...
distance.matrix.CHN <- rdist.earth(CHall_lon.lat)  ##great circle dist based on the coordinates
...
ibd.CHN <- mantel.randtest(Dgen.Euc.CHN, Dgeo.CH)   
...
distance.matrix.CHS <- rdist.earth(CHall_lon.lat)  ##great circle dist based on the coordinates
...
distance.matrix.CZ <- rdist.earth(CZ_lon.lat)  ##great circle dist based on the coordinates
Dgeo.CZ <- as.dist(distance.matrix.CHS)
...
distance.matrix.CHS.VS <- rdist.earth(CHS.VS_lon.lat)  ##great circle dist based on the coordinates
...
distance.matrix.CHS.TI <- rdist.earth(CHS.TI_lon.lat)  ##great circle dist based on the coordinates
...
![alt_txt][IBD2]
[IBD2]:https://cloud.githubusercontent.com/assets/12142475/19455767/9eaca0d8-94be-11e6-8350-7b33573feffd.png
