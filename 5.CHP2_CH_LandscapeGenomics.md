...
[Hs.temp.layingdate]:https://cloud.githubusercontent.com/assets/12142475/19434759/9bee6734-9467-11e6-9910-fa40b281e9d4.png
...
par()  ##opens an image. Can use .pdf or .png and end with dev.off() to save figure.
heatmap.2(as.matrix(CHall.fst), trace="none", RowSideColors=DendColours, ColSideColors=Dend.elev, col=shadesOfGrey, labRow=F, labCol=F)  ##RowSideColors is for the dendrogram on the row, ColSideColors for the upper dendrogram. Colour order should be the same as the input. 

legend("topright", legend=c("low", "mid", "high"), col=c("darkslategray4", "darkslategray3", "darkslategray1"))
```
