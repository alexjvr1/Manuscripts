...
lambda = median(zs4.1^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values4.1 = pchisq(zs.stouffer4.1^2/lambda, df = 1, lower = FALSE)
hist(cp.values4.1)

zs4.2 = z.scores(project, K = 4, d=2)
zs.stouffer4.2 = apply(zs4.2, MARGIN = 1, median)
lambda = median(zs4.2^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values4.2 = pchisq(zs.stouffer4.2^2/lambda, df = 1, lower = FALSE)

zs4.3 = z.scores(project, K = 4, d=3)
zs.stouffer4.3 = apply(zs4.3, MARGIN = 1, median)
lambda = median(zs4.3^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values4.3 = pchisq(zs.stouffer4.3^2/lambda, df = 1, lower = FALSE)

zs4.4 = z.scores(project, K = 4, d=4)
zs.stouffer4.4 = apply(zs4.4, MARGIN = 1, median)
lambda = median(zs4.4^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values4.4 = pchisq(zs.stouffer4.4^2/lambda, df = 1, lower = FALSE)

zs4.5 = z.scores(project, K = 4, d=5)
zs.stouffer4.5 = apply(zs4.5, MARGIN = 1, median)
lambda = median(zs4.5^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values4.5 = pchisq(zs.stouffer4.5^2/lambda, df = 1, lower = FALSE)

zs5.1 = z.scores(project, K = 5, d=1)
zs.stouffer5.1 = apply(zs5.1, MARGIN = 1, median)
lambda = median(zs5.1^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values5.1 = pchisq(zs.stouffer5.1^2/lambda, df = 1, lower = FALSE)

zs5.2 = z.scores(project, K = 5, d=2)
zs.stouffer5.2 = apply(zs5.2, MARGIN = 1, median)
lambda = median(zs5.2^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values5.2 = pchisq(zs.stouffer5.2^2/lambda, df = 1, lower = FALSE)

zs5.3 = z.scores(project, K = 5, d=3)
zs.stouffer5.3 = apply(zs5.3, MARGIN = 1, median)
lambda = median(zs5.3^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values5.3 = pchisq(zs.stouffer5.3^2/lambda, df = 1, lower = FALSE)

zs5.4 = z.scores(project, K = 5, d=4)
zs.stouffer5.4 = apply(zs5.4, MARGIN = 1, median)
lambda = median(zs5.4^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values5.4 = pchisq(zs.stouffer5.4^2/lambda, df = 1, lower = FALSE)

zs5.5 = z.scores(project, K = 5, d=5)
zs.stouffer5.5 = apply(zs5.5, MARGIN = 1, median)
lambda = median(zs5.5^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values5.5 = pchisq(zs.stouffer5.5^2/lambda, df = 1, lower = FALSE)

zs6.1 = z.scores(project, K = 6, d=1)
zs.stouffer6.1 = apply(zs6.1, MARGIN = 1, median)
lambda = median(zs6.1^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values6.1 = pchisq(zs.stouffer6.1^2/lambda, df = 1, lower = FALSE)

zs6.2 = z.scores(project, K = 6, d=2)
zs.stouffer6.2 = apply(zs6.2, MARGIN = 1, median)
lambda = median(zs6.2^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values6.2 = pchisq(zs.stouffer6.2^2/lambda, df = 1, lower = FALSE)

zs6.3 = z.scores(project, K = 6, d=3)
zs.stouffer6.3 = apply(zs6.3, MARGIN = 1, median)
lambda = median(zs6.3^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values6.3 = pchisq(zs.stouffer6.3^2/lambda, df = 1, lower = FALSE)

zs6.4 = z.scores(project, K = 6, d=4)
zs.stouffer6.4 = apply(zs6.4, MARGIN = 1, median)
lambda = median(zs6.4^2)/.456  
lambda  ##note down lambda for the different K
# calculate adjusted p-values
cp.values6.4 = pchisq(zs.stouffer6.4^2/lambda, df = 1, lower = FALSE)

zs6.5 = z.scores(project, K = 6, d=5)
zs.stouffer6.5 = apply(zs6.5, MARGIN = 1, median)
lambda = median(zs6.5^2)/.456  
lambda  ##note down lambda for the different K

# calculate adjusted p-values
cp.values6.5 = pchisq(zs.stouffer6.5^2/lambda, df = 1, lower = FALSE)
