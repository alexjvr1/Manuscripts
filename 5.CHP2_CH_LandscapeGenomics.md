...
![alt_txt][rcorr.CH46Env]
[rcorr.CH46Env]:https://cloud.githubusercontent.com/assets/12142475/19192527/cd8340d0-8ca6-11e6-8699-b27b591b4410.png

![alt_txt][rcorr.CH6Env]
[rcorr.CH6Env]:https://cloud.githubusercontent.com/assets/12142475/19193186/67a4849c-8ca9-11e6-8371-258ea25be5fb.png

Although, if I included the interpolated degC on the laying date, this comes out as a highly uncorrelated variable. Which could be quite interesting. So I will include this as a 7th Env variable: 

![alt_txt][rcorr.CH6Env.layingdate]
[rcorr.CH6Env.layingdate]:https://cloud.githubusercontent.com/assets/12142475/19193473/709fcab0-8caa-11e6-8541-6a4772aff18e.png
...
dat2 <- dat[,1:41]
head(dat2)
HighCorr <- findCorrelation(cor(dat2), cutoff = 0., verbose=T)
head(HighCorr)
