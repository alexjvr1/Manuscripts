...
```
plot(sum.CHall$n.by.pop, sum.CHall$pop.n.all)
```
...
![alt_txt][SumStat1]
[SumStat1]:https://cloud.githubusercontent.com/assets/12142475/19389643/04fccf62-9225-11e6-9ec8-2239396fdfe9.png



Overall obsH vs expH
```
plot(sum.CHall$Hexp, sum.CHall$Hobs, ylab="Observed Heterozygosity", xlab="Expected Heterozygosity")
```

![alt_txt][sumstats2]
[sumstats2]:https://cloud.githubusercontent.com/assets/12142475/19389919/287ffa80-9226-11e6-8a86-4c27c8b6fc52.png
...
And corrolate OHet per pop with env variables
```
