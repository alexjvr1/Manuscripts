...
m2.CHall$IBD <- m2.CHall/(1-m2.CHall$distance)
...
library(MASS)
pdf("CHall.IBD.pdf")
plot(CHall.m2$IBD~CHall.m2.dist$log.km, pch=20,cex=.5, xlab="log Geographic distance (km)", ylab="Fst/(1-Fst)")
abline(fit <- lm(CHall.m2$IBD~CHall.m2.dist$log.km))
legend("bottomright", bty="n", legend=paste("R2 =", format(summary(fit)$adj.r.squared, digits=4)))  ##and paste R2
...
m2.CHN$IBD <- m2.CHN/(1-m2.CHN$distance)
...
library(MASS)
pdf("CHN.IBD.pdf")
plot(CHN.m2$IBD~CHN.m2.dist$log.km, pch=20,cex=.5, xlab="log Geographic distance (km)", ylab="Fst/(1-Fst)")
abline(fit <- lm(CHN.m2$IBD~CHN.m2.dist$log.km))
legend("bottomright", bty="n", legend=paste("R2 =", format(summary(fit)$adj.r.squared, digits=4)))  ##and paste R2
...
m2.CHS$IBD <- m2.CHall/(1-m2.CHS$distance)
...
library(MASS)
pdf("CHS.IBD.pdf")
plot(CHS.m2$IBD~CHS.m2.dist$log.km, pch=20,cex=.5, xlab="log Geographic distance (km)", ylab="Fst/(1-Fst)")
abline(fit <- lm(CHS.m2$IBD~CHS.m2.dist$log.km))
legend("bottomright", bty="n", legend=paste("R2 =", format(summary(fit)$adj.r.squared, digits=4)))  ##and paste R2
...
m2.CHS.TI$IBD <- m2.CHS.TI/(1-m2.CHS.TI$distance)
...
library(MASS)
pdf("CHS.TI.IBD.pdf")
plot(CHS.TI.m2$IBD~CHS.TI.m2.dist$log.km, pch=20,cex=.5, xlab="log Geographic distance (km)", ylab="Fst/(1-Fst)")
abline(fit <- lm(CHS.TI.m2$IBD~CHS.TI.m2.dist$log.km))
legend("bottomright", bty="n", legend=paste("R2 =", format(summary(fit)$adj.r.squared, digits=4)))  ##and paste R2
...
m2.CHS.VS$IBD <- m2.CHS.VS/(1-m2.CHS.VS$distance)
...
library(MASS)
pdf("CHS.VS.IBD.pdf")
plot(CHS.VS.m2$IBD~CHS.VS.m2.dist$log.km, pch=20,cex=.5, xlab="log Geographic distance (km)", ylab="Fst/(1-Fst)")
abline(fit <- lm(CHS.VS.m2$IBD~CHS.VS.m2.dist$log.km))
legend("bottomright", bty="n", legend=paste("R2 =", format(summary(fit)$adj.r.squared, digits=4)))  ##and paste R2
...
m2.CZ$IBD <- m2.CZ/(1-m2.CZ$distance)
...
library(MASS)
pdf("CZ.IBD.pdf")
plot(CZ.m2$IBD~CZ.m2.dist$log.km, pch=20,cex=.5, xlab="log Geographic distance (km)", ylab="Fst/(1-Fst)")
abline(fit <- lm(CZ.m2$IBD~CZ.m2.dist$log.km))
legend("bottomright", bty="n", legend=paste("R2 =", format(summary(fit)$adj.r.squared, digits=4)))  ##and paste R2
