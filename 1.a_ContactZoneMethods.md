...
3. loci.dat = column 1: locus names, column 2 (type): c (for co-dominant markers)
	
	Generate this by copying all the locus names from the Plink.map file and pasting c in the second column.  
