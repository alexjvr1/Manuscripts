...
From the manual it looks to me to be parameter -u: max deviate from uniform for proposed hybrid index. In the last run this was set really strictly (-u 0.05). I've changed this to 0.02
...
Started 12 Sept 14:10. Expected finish: 15 Sept
