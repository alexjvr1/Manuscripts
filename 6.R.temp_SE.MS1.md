...
Once the genome is ready, I can map and call more SNPs. I'll do this later, or for a comparison between the Swiss and Swedish datasets. 
...
sort.SE167$pop <- factor(sort.SE167$pop, levels=sort.SE167$pop) ##pop is a factor so it doesn't get resorted. 
```
