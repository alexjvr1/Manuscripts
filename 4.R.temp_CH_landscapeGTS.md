...
CHS.TI.m2 <- melt(m.CHS.TI)[melt(upper.tri(m.CHS.TI))$value,]
...
m2.CHS.TI.Fst <- melt(m.CHS.TI.Fst)[melt(upper.tri(m.CHS.TI.Fst))$value,]
...
m2.CHS.TI.Euc <- melt(m.CHS.TI.Euc)[melt(upper.tri(m.CHS.TI.Euc))$value,]
